...
public final class AuthConst {
    ...
    public static final String LOGIN_URL = "/admin/login.html";
    public static final List<String> NO_AUTH = Arrays.asList("/favicon.ico", "/error", "/res/**",
            LOGIN_URL, FILES, "/auth/**", "/front/**");
